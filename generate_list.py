...
OUT_CLIENT_PATH = "client"
OUT_SERVER_PATH = "server"
...
class FileService:
    ...
    def __init__(self):
        ...
        if not os.path.exists(OUT_CLIENT_PATH):
            os.makedirs(OUT_CLIENT_PATH)
        if not os.path.exists(OUT_SERVER_PATH):
            os.makedirs(OUT_SERVER_PATH)
        cf = open(os.path.join(OUT_CLIENT_PATH, OUT_CLIENT_FILE), "w")
        sf = open(os.path.join(OUT_SERVER_PATH, OUT_SERVER_FILE), "w")
        self.cfile = cf
        self.sfile = sf
